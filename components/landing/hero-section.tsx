  ...
  return (
    ...
    >
      ...
      <h1 className="bg-gradient-to-br dark:from-white from-black from-30% dark:to-white/40 to-black/40 bg-clip-text py-6 text-5xl font-medium leading-none tracking-tighter text-transparent text-balance sm:text-6xl md:text-7xl lg:text-8xl translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
        Kumar Enterprises
        <br className="hidden md:block" /> Full-Stack Innovation.
      </h1>
      <p className="mb-12 text-lg tracking-tight text-gray-400 md:text-xl text-balance translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
        We build high-performance Web and Mobile applications using Next.js, MERN,
        <br className="hidden md:block" /> React Native, and Kotlin. Your vision, expertly crafted.
      </p>
