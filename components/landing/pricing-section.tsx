...
const demoPrices = [
  {
    id: "price_1",
    name: "Web Starter",
    description: "Launch your online presence with a modern landing page.",
    features: [
  ...
  },
  {
    id: "price_2",
    name: "Full-Stack Pro",
    description: "Complete Web and Mobile solution for your business.",
    features: [
  ...
  },
  {
    ...
    description: "High-performance native apps and scalable systems.",
    features: [
  ...
  },
  {
    ...
    description: "A tailored digital ecosystem for industry leaders.",
    features: [
      "Full Web & Mobile Suite",
      "Dedicated Dev Team",
      "Custom Security & Scalability",
      "24/7 Monitoring",
